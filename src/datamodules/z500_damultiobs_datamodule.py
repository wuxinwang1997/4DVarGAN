...
from src.datamodules.components.z500_damultiobs_dataset import Z500_DAMO_Dataset
from src.data_factory.convert_z500 import convert_z500

class Z500DADataModule(LightningDataModule):
    ...
    def setup(self, stage: Optional[str] = None):
        ...
        if not self.data_train and not self.data_val and not self.data_test:
            self.data_train = Z500_DA_Dataset(
                ...
                correct=self.hparams.correct,
            )
            self.data_val = Z500_DA_Dataset(
                self.hparams.data_dir, 
                self.hparams.xb_dir, 
                self.hparams.init_time,
                self.hparams.obs_dir,
            ...
            self.data_test = Z500_DA_Dataset(
                self.hparams.data_dir, 
                self.hparams.xb_dir, 
                self.hparams.init_time,
                self.hparams.obs_dir,
