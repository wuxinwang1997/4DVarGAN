...
def daloop_inference(era5_dir,
    ...
    xb_iter.to_netcdf(f'{output_dir}/xb_iter_{da_model.lower()}_inflation{inflation}_obspartial{obs_partial}.nc')
    print(f'{output_dir}/xb_iter_{da_model.lower()}_inflation{inflation}_obspartial{obs_partial}.nc saved!')
    fc_iter.to_netcdf(f'{output_dir}/fc_iter_{da_model.lower()}_inflation{inflation}_obspartial{obs_partial}.nc')
    print(f'{output_dir}/fc_iter_{da_model.lower()}_inflation{inflation}_obspartial{obs_partial}.nc saved!')
    xr_rmse.to_netcdf(f'{output_dir}/rmse_{da_model.lower()}_inflation{inflation}_obspartial{obs_partial}.nc')
    print(f'{output_dir}/rmse_{da_model.lower()}_inflation{inflation}_obspartial{obs_partial}.nc saved!')
    xr_acc.to_netcdf(f'{output_dir}/acc_{da_model.lower()}_inflation{inflation}_obspartial{obs_partial}.nc')
    print(f'{output_dir}/acc_{da_model.lower()}_inflation{inflation}_obspartial{obs_partial}.nc saved!')
    xr_mae.to_netcdf(f'{output_dir}/mae_{da_model.lower()}_inflation{inflation}_obspartial{obs_partial}.nc')
    print(f'{output_dir}/mae_{da_model.lower()}_inflation{inflation}_obspartial{obs_partial}.nc saved!')
    np.save(f'{output_dir}/da_time_{da_model.lower()}_inflation{inflation}_obspartial{obs_partial}.npy', times4da)
